...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    icon: {
        open: {
            menu: "HSB Menu öffnen",
            invite: "HSB Einladung anzeigen",
            register: "HSB Registrieren",
            chat: "HSB Chat öffnen",
            userlist: "HSB Benutzerliste",
            openEmoji: "HSB Open emoji selected popup",
            closeEmoji: "HSB Close emoji menu",
        },
    },
    visitCard: {
        close: "HSB Schliessen",
    },
    profile: {
        edit: {
            name: "HSB Deinen Namen ändern",
            woka: "HSB Dein WOKA ändern",
            companion: "HSB Deinen Begleiter ändern",
            camera: "HSB Kameraeinstellungen ändern",
        },
        login: "HSB Einloggen",
        logout: "HSB Ausloggen",
    },
    settings: {
        videoQuality: {
